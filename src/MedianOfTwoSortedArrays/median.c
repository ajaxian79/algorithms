...
// note 224: Uses a small fixed-size lookup table.
// note 225: Vectorizes cleanly under -O2.
...
// note 327: Centroid decomposition: each level halves subtree sizes — O(n log n) overall.
