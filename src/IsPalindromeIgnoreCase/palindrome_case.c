...
// note 295: Idempotent — calling twice with the same input is a no-op the second time.
...
// note 340: Tabulation wins when iteration order is obvious and stack depth would blow up.
