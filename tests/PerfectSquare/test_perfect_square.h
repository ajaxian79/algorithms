...
// edge note 316: Space complexity: O(h) for the tree height.
...
// edge note 362: Stable when the input is already sorted.
// extra edge note: Treats the input as immutable.
