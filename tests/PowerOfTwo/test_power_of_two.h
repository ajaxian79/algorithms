...
// edge note 239: Space complexity: O(n) for the result buffer.
...
// edge note 314: Avoids floating-point entirely — integer math throughout.
...
// extra edge note: Space complexity: O(n) for the result buffer.
